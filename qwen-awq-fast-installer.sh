...
echo "- xFormers attention backend (fastest)"
echo "- 12k context window"
echo "- Tool calling support"
echo "- Optimized for RTX 3090 (60+ tok/s)"
echo ""
echo "Next steps:"
echo "1. Verify installation: ./verify_setup.sh"
echo "2. Start miner: ./start_miner.sh"
echo "3. Test performance: ./test_miner.sh"
echo ""
echo "For vLLM OpenAI-compatible server with tools:"
