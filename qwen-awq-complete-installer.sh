#!/bin/bash
# Qwen2.5-7B-Instruct-AWQ Complete Installer - Includes System Dependencies
# Production grade with vLLM and all prerequisites
...
echo "=== Qwen2.5-7B-Instruct-AWQ Complete Installer ==="
echo "Date: $(date)"
...
pip install --index-url https://pypi.org/simple transformers accelerate flask waitress requests psutil
...
ALLOWLIST=(
    ...
    "flask" "waitress" "flask-cors" "importlib-metadata" "zipp" "scipy"
    "ray" "aiosignal" "frozenlist" "multidict" "yarl" "aiohttp" "async-timeout"
    "openai" "distro" "tiktoken" "prometheus-client" "prometheus-fastapi-instrumentator"
