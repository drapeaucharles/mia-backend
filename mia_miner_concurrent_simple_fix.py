#!/usr/bin/env python3
"""
MIA GPU Miner - Simple Language Fix
Just tell the model to match the user's language, default to English
"""
import os
...
def generate():
    ...
    try:
        ...
        # SIMPLE: Just tell the model to respond in the same language
        # The model should be smart enough to detect the language itself
        system_message = """You are MIA, a helpful multilingual AI assistant. 
...
If you're not sure what language the user is using, default to English.
...
def main():
    logger.info("=" * 60)
    logger.info("MIA GPU Miner - Simple Language Fix")
    logger.info("Let the model detect language itself")
    logger.info("=" * 60)
