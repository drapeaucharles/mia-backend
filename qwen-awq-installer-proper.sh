#!/bin/bash
# Qwen AWQ Miner Installer - Proper installation from source

echo "🚀 Installing Qwen AWQ Miner (Proper Method)"
echo "==========================================="
...
echo "📦 Installing system dependencies and build tools..."
apt-get update
apt-get install -y \
    python3.11 \
    python3.11-dev \
...
# Install vLLM from source with proper dependencies
echo "⚡ Installing vLLM from source..."
# First install dependencies
pip install ray>=2.9.0 pandas pyarrow

# Install vLLM
pip install vllm==0.2.7 --no-build-isolation

# Install AutoAWQ for quantization support
...
#!/usr/bin/env python3
"""
MIA Qwen AWQ Miner - Properly Built
"""
import os
import sys
import json
...
echo "========================"
echo ""
echo "All packages installed from source with proper build tools."
echo ""
