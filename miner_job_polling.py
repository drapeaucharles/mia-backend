...
MINER_ID = 1  # You need to register and get your miner ID
...
if __name__ == "__main__":
    # Check if miner ID is set
    if MINER_ID == 1:
        print("\n⚠️  WARNING: Using default miner ID (1)")
        print("You should register your miner and update MINER_ID in this script")
        print("Or set environment variable: export MINER_ID=your_id")
        print("")
        
        # Allow override from environment
        if os.getenv('MINER_ID'):
            MINER_ID = int(os.getenv('MINER_ID'))
            print(f"Using MINER_ID from environment: {MINER_ID}")
